...
//    }
//
//    public ResponseEntity<NotExistBadDataResultResponse> AllControl(Exception e, HttpStatus status) {
//        NotExistBadDataResultResponse notExistBadDataResultResponse = new NotExistBadDataResultResponse(status.value(), e.getMessage());
//        return new ResponseEntity<NotExistBadDataResultResponse>(notExistBadDataResultResponse, status);
//    }
//
//    @AllArgsConstructor
